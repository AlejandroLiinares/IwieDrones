...
const Forestry = () => {
  // Datos de ejemplo para tecnologías forestales
  const forestryTech = [
    {
      id: 1,
      name: "Sistema Forestal FF-300",
      ...
      specs: [
        ...
        "Resistencia: IP65",
        "Cobertura: 5 hectáreas/operación",
    ...
    {
      id: 2,
      name: "Sistema de Monitoreo Forestal FM-100",
    ...
    {
      id: 3,
      name: "Sistema de Siembra Forestal FS-200",
      ...
      specs: [
        ...
        "Cobertura: 2 hectáreas/operación",
    ...
    <div className="service-page forestry-page">
      ...
      <section className="service-hero">
        <div className="container">
          <h1>Servicios Forestales con Tecnología Avanzada</h1>
        ...
        <div className="container">
          <div className="overview-content">
            <div className="overview-text">
              ...
              <p>En Iwie Technologies ofrecemos servicios especializados para el sector forestal mediante el uso de tecnología aérea de última generación para monitoreo, fumigación y protección de bosques y áreas naturales.</p>
              ...
              <h3>Ventajas de la Tecnología Aérea en el Sector Forestal</h3>
            ...
            <div className="overview-image">
              <img src="https://via.placeholder.com/600x400" alt="Tecnología en entorno forestal" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="tech-catalog">
        <div className="container">
          <h2 className="section-title">Nuestra Tecnología Forestal</h2>
          <p className="section-description">Contamos con equipos especializados para diferentes aplicaciones en el sector forestal.</p>
          
          <div className="tech-list">
            {forestryTech.map(tech => (
        ...
        <div className="container">
          ...
          <div className="process-steps">
            <div className="process-step">
              ...
              <p>Implementación de un sistema de monitoreo aéreo que permitió detectar un foco de incendio en fase inicial, evitando la pérdida de más de 500 hectáreas de bosque nativo.</p>
            </div>
            <div className="process-step">
              <img src="https://via.placeholder.com/300x200" alt="Caso de éxito" style={{width: '100%', borderRadius: '8px', marginBottom: '1rem'}} />
              <h3>Parque Nacional Sierra Alta</h3>
              <p>Control efectivo de plaga de escarabajo descortezador mediante fumigación selectiva con tecnología aérea, preservando la salud de más de 1,000 hectáreas de pinos.</p>
            </div>
            <div className="process-step">
              <img src="https://via.placeholder.com/300x200" alt="Caso de éxito" style={{width: '100%', borderRadius: '8px', marginBottom: '1rem'}} />
              <h3>Proyecto de Reforestación Valle Verde</h3>
              <p>Reforestación de 200 hectáreas en terrenos escarpados mediante siembra aérea con tecnología avanzada, logrando una tasa de germinación superior al 70%.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="service-cta">
        <div className="container">
          <h2>¿Necesitas soluciones forestales con tecnología avanzada?</h2>
